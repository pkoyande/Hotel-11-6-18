	...
	private void login() {
		...
		try {
			...
			+ "4. Exit" + " Enter choice: ");
				...
				//	System.out.println("Room Details are as follows: "+ room.getRoomId()+ "  "+room.getRoomNo()+"  "+room.getRoomType()+"  "+ 
									//	room.getPerNightRate()+ "  " + room.getAvailability());
					break;
				case 2:
			...
			public void performRoomManagement() {
				 ...
				 while (true) {
					...
					case 1:
						...
						room.getHotel().setHotelId((sc.nextInt()));
						
						//System.out.print("Enter Room Id");
						room.setRoomId();
						
						System.out.print("Enter Room No. ");
						room.setRoomNo(sc.next());
						
						
						System.out.print("Enter Per Night Rate: ");
						room.setPerNightRate(sc.nextDouble());
						
						
						
						
						System.out.print("Enter Availability: ");
						room.setAvailability(sc.next());
						
						try {
							roomId = service.addRoom(room);
						} catch (Exception e) {
							System.out.println(e.getMessage());
						}
						if (roomId != 0) {
					...
					case 2:
						...
						if(flag)
						{
								System.out.println("Room with Room Id " + rId + " deleted successfullyy");
						}
					//	deleteRoom();
